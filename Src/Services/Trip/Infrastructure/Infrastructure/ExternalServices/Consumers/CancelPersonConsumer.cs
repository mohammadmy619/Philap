...
namespace Infrastructure.Consumers
{
    ...
    public class CancelTripEventConsumer : IConsumer<ICancelPersonEvent>
    {
        private readonly ILogger<CancelTripEventConsumer> _logger;
        private readonly ITripRepository _tripRepository;

        public CancelTripEventConsumer(
            ILogger<CancelTripEventConsumer> logger,
